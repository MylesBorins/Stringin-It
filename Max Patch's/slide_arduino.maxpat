{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 83.0, 128.0, 905.0, 666.0 ],
		"bglocked" : 0,
		"defrect" : [ 83.0, 128.0, 905.0, 666.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"linecount" : 2,
					"fontsize" : 8.0,
					"patching_rect" : [ 469.0, 454.0, 103.0, 25.0 ],
					"numinlets" : 1,
					"id" : "obj-44",
					"numoutlets" : 0,
					"fontname" : "Arial"
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"fontsize" : 12.0,
					"patching_rect" : [ 456.0, 480.0, 41.0, 18.0 ],
					"numinlets" : 2,
					"id" : "obj-45",
					"numoutlets" : 1,
					"fontname" : "Arial"
...
, 			{
				"box" : 				{
					...
					"fontsize" : 12.0,
					"patching_rect" : [ 404.0, 452.0, 62.0, 20.0 ],
					"numinlets" : 1,
					"id" : "obj-46",
					"numoutlets" : 3,
					"fontname" : "Arial"
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"fontsize" : 12.0,
					"patching_rect" : [ 431.0, 499.0, 39.0, 18.0 ],
					"numinlets" : 2,
					"id" : "obj-47",
					"numoutlets" : 1,
					"fontname" : "Arial"
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"size" : 255.0,
					"patching_rect" : [ 577.0, 328.0, 18.0, 144.0 ],
					"numinlets" : 1,
					"id" : "obj-48",
					"numoutlets" : 1
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"fontsize" : 9.0,
					"patching_rect" : [ 492.0, 545.0, 32.0, 15.0 ],
					"numinlets" : 2,
					"id" : "obj-49",
					"numoutlets" : 1,
					"fontname" : "Arial"
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "" ],
					"fontsize" : 9.0,
					"patching_rect" : [ 568.0, 525.0, 71.0, 17.0 ],
					"numinlets" : 1,
					"id" : "obj-50",
					"numoutlets" : 2,
					"fontname" : "Arial"
...
, 			{
				"box" : 				{
					...
					"linecount" : 3,
					"fontsize" : 9.0,
					"patching_rect" : [ 600.0, 384.0, 105.0, 38.0 ],
					"numinlets" : 1,
					"id" : "obj-51",
					"numoutlets" : 0,
					"fontname" : "Arial"
...
, 			{
				"box" : 				{
					...
					"linecount" : 2,
					"fontsize" : 9.0,
					"patching_rect" : [ 430.0, 530.0, 125.0, 27.0 ],
					"numinlets" : 1,
					"id" : "obj-52",
					"numoutlets" : 0,
					"fontname" : "Arial"
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"fontsize" : 9.0,
					"patching_rect" : [ 443.0, 256.0, 39.0, 15.0 ],
					"numinlets" : 2,
					"id" : "obj-12",
					"numoutlets" : 1,
					"fontname" : "Arial"
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 501.5, 520.0, 577.5, 520.0 ]
				}
